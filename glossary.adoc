...
|Berechnete Elemente|Physikalische Größen und Diagramme, welche im Rahmen eines Berechnungsvorgangs ermittelt wurden|Berechnungsergebnisse
|Eingabedaten|Daten, welche ein Systemnutzer in ein Softwaresystem eingibt, abhängig von Art der Berechnung|
