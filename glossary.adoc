...
|i|Index-Nummer des Materials|1|Bezeichnung eines Materials innerhalb einer Rechenaufgabe
...
|Temperaturdaten|Δϑ~k~, ϑ~k~, Δϑ~e~, ϑ~i~|Double|≥ 0 (bei Kelvinskala), beziehungsweise ≥ -273,15 (bei Celsiusskala)|
