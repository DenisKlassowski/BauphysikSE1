...
| Erste TEST-CASE | niedrig | 1 | NOT DONE | x | I1 | Christian Lehmann | 0 | 0 
...
| Kunde wirk unsicher bei Vorstellung der Idee / Kunde weiß nicht genau was er will| NO LONGER A PROBLEM | Unsicherheiten wurden in It2 beseitigt 
|===
...
Fast alle für Iteration 1 geplanten Aufgaben wurden erfolgreich bearbeitet. Noch nicht viele geplanten Aufgaben für Iteration 2.
