...
| Vision erstellen | hoch   | 3 | DONE | x | I1 | Grambole Lukas Däbler Michael | 5 | 6
| Glossar erstellen | mittel   | 2 | DONE | x | I1 | Grambole Lukas Däbler Michael | 1 | 1
| Nichtfunktionale Anforderungen erfassen | hoch   | 1 | DONE | x | I1 | Grambole Lukas Däbler Michael | 1 | 2
| x | x | x | x | x | x | x | x | x 
|===
