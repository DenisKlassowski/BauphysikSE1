...
| Use-Cases ausarbeiten und vertiefen | hoch   | 4 | NOT DONE | x | I2 | Grambole Lukas Däbler Michael | BITTE EINTRAGEN | 3
| Nichtfunktionale Anforderungen erfassen | hoch   | 2 | NOT DONE | x | I2 | Grambole Lukas Däbler Michael | BITTE EINTRAGEN | 1
