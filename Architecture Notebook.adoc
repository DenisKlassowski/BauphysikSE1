...
Hier wird Definiert, wie das System auf Änderungen reagieren wird.

.Die Softwarelösung soll unabhängig, nach Download, vom Internet funktionieren.           //Erweitern
.Regelmäßige Prüfung, über einen Server im Internet, auf Updates.                         //Erweitern
