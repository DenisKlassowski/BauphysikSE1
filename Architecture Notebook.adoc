...
Das Programm soll auf einem USB-Speichermedium ausführbar sein und ist nur für die Eigenbenutzung gedacht(kurzfristige Nutzung durch andere möglich). +
...
. Nutzer verwenden Dekstop-PC oder Laptop.
