...
. Software wird mit dem GUI tool PyQT in Python geschrieben mit einer GNU / GPL License. (Für unsere Developer PyQT: https://www.qt.io/blog/2018/12/18/qt-python-5-12-released GNU / GPL License) Neuer Stakeholder QT
