...
. Team hat wenig Projekt Erfahrung.
. Entwickler haben wenig Erfahrung.
...
. Software wird mit dem GUI tool PyQT 5.12.6 in Python geschrieben mit einer GNU / GPL License. (Für unsere Developer PyQT: https://www.qt.io/blog/2018/12/18/qt-python-5-12-released GNU / GPL License) Neuer Stakeholder QT
