...
. Software wird mit dem GUI tool PyQT 5.12 in Python  geschrieben. (Für unsere Developer https://www.qt.io/blog/2018/12/18/qt-python-5-12-released GNU / GPL License)
