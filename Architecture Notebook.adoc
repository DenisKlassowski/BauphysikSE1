...
. Das System darf, wenn PDF's erstellt werden und der Computer/ das Programm abstürzt, höchstens die Aktuelle Aufgabe verlieren. 
...
. Python Bibliothek Pyfpdf zur Erstellung der PDF's.
...
Persistenz +
Die Erstellten Rechnungen sollen, bei Wunsch des erstellens einer PDF, nicht bei Absturz des Systems Verloren gehen(Ausnahme: Aktuelle Rechnung). +
