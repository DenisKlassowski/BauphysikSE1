...
|Drucker|Software von handelsüblichen Druckern|verarbeitet Druckauftrag aus dem Softwaresystem
...
|Eingabedaten veranschaulichen|mittel|Darstellung der verschiedenen Wandschichten|xx
