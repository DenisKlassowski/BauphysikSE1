...
|Hacker|	IT-Spezialisten mit negativen Absichten	| versuchen in das Softwaresystem einzudringen und dem Endanwender zu schaden
|===
=== Benutzerumgebung
...
* Das Softwaresystem ist gemäß Anweisung der Auftraggeberin primär an ihrer Benutzerumgebung auszurichten.
...
|Berechnungsergebnisse ausgeben|hoch|Ausgabe von U, R~T~, R~ges~, R~i~ |xx
