...
|UC3 |Daten drucken|Systemnutzer|Druck auswählbarer Informationen
|UC4 |Materialdaten editieren |Systemnutzer|Änderung von Materialdaten
...
include::usecase_spec_Materialdaten_editieren.adoc[]
