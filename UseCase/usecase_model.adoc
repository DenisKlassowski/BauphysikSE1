...
|UC8 |Parallelberechnung durchführen|Systemnutzer| Berechnung und Ausgabe von j, R~ges~, R~i~, R~T~, U, Δϑ~k~ und ϑ~k~ für Bauteile mit parallelen Wandschichten
|UC9 |Tauwasserfreiheit ermitteln|Systemnutzer|Berechnung der Kondenswasserbildung an Bauteilen|
|===
